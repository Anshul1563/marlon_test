...
def XMLtoCSV(file):
    options = Namespace(configuration_file=None, save_configuration=None, save_template=None, source=file, output=None, separator=';', quotechar='', xsd=None, validation=False, split=False, _prefixed_options={}, config_as_string='<configuration>\n    <source value="sumoplots/Summary_E1.xml"/>\n</configuration>\n')
    # get attributes
